...
describe('Login Component', () => {
  ...
  beforeEach(async () => {
    ...
    fixture.detectChanges(); // for ng oninit 
  ...
  it('empty password', () => {
    page.updateValue(page.usernameInput, 'admin'); // for branch coverage

    expect(loginComponent.username).toBe('admin'); // for branch coverage
  ...
  it('Valid credentials', waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      const navArgs = (router.navigateByUrl as jasmine.Spy).calls.first().args[0];
  ...
  it('Invalid credentials', fakeAsync(() => {
    ...
    page.updateValue(page.usernameInput, 'admin');
    page.updateValue(page.passwordInput, 'asdf');
